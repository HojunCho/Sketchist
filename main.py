...
def main(args):
    ...
    train_loader = SketchDataLoader(root='~/Data/Datasets/Flickr-Face-HQ', train=not args.debug, sketch_type='XDoG', size=256, size_from='images',
                                    batch_size=args.batch_size, shuffle=True, num_workers=2, device=device)
    test_loader = SketchDataLoader(root='~/Data/Datasets/Flickr-Face-HQ', train=False, sketch_type='XDoG', size=256, size_from='images',
                                    batch_size=args.batch_size, shuffle=True, num_workers=2, device=device)
